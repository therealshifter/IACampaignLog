...
namespace IACampaignLog
{
   ...
   {
      private Label _playerNameLabel, _heroNameLabel, _xpLabel,
                    _itemListLabel, _classCardListLabel, _rewardListLabel;
      private Button _addItemButton, _addClassCardButton, _addRewardButton;
      private ComboBox _addClassCombo, _addRewardCombo;
      protected ComboBox _addItemCombo;
      private ListView _classCardListView, _rewardListView;
      protected ListView _itemListView;
      protected ContextMenu _itemContextMenu;
      protected MenuItem _itemActionMenuItem;
      ...
      private void Initialise()
      {
         ...
         _itemActionMenuItem = new MenuItem();
         _itemContextMenu.MenuItems.Add(_itemActionMenuItem);
      }
   }
}
